...
# Author: Qian Taotao                                                          #
# --------------------------------------------------------------------------   #
# Last Modified: Thursday August 31st 2023 12:09:50 am                         #
...
def dump(stage):
    p = Popen(args=f'./toyc-ch7 ./codegen.toy -emit={stage} -opt', shell=True, executable='/usr/bin/bash', stdout=PIPE, stderr=PIPE)
